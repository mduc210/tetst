...
def get_page(cookie):
    ...
    try:
        ...
        print(f"\033[1;31mError: Failed to fetch page: {e}")
        return None

    # Check if the response contains the expected fb_dtsg field
    if '<input type="hidden" name="fb_dtsg" value="' not in response:
        print("\033[1;31mError: Could not find fb_dtsg in the response. The cookie might be invalid or Facebook page structure has changed.")
        return None
    ...
    try:
        ...
        print("\033[1;31mError: Failed to parse fb_dtsg or jazoest. The cookie might be invalid or the page structure has changed.")
        return None

    try:
        idpef = requests.post('https://www.facebook.com/api/graphql/', headers=headers, data={
            'fb_dtsg': fb_dtsg,
            'jazoest': jazoest,
        ...
        print(f"\033[1;31mError: Failed to fetch profile data: {e}")
        return None
